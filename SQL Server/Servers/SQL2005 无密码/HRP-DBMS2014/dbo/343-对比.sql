...
into tk060
from OPENROWSET('Microsoft.ACE.OLEDB.12.0','Excel 5.0;HDR=YES;DATABASE=D:\Desktop\交控\公路桥梁明细表（国省道）-安徽省交通控股集团有限公司(2024-02-28).xlsx',sheet2$)
...
--UPDATE [HRP-DBMS2014]..k060 SET A1305=RTRIM([F48]),K6050=[F49] 
from  #tk060
left join [HRP-DBMS2014]..k060  on k6040=F58 
