select A0102,'0',sum(isnull(a0307,0)+isnull(a0308,0)+isnull(a0310,0)+isnull(a0311,0)+isnull(a0312,0))
from A11
...
GROUP BY A0102
UNION
select A0102,'1c',sum(isnull(a0307,0)+isnull(a0308,0)+isnull(a0310,0)+isnull(a0311,0)+isnull(a0312,0))
from A11
...
GROUP BY A0102
UNION
select A0102,'2x',sum(isnull(a0307,0)+isnull(a0308,0)+isnull(a0310,0)+isnull(a0311,0)+isnull(a0312,0))
from A11
...
GROUP BY A0102
UNION
select A0102,'3y',sum(isnull(a0307,0)+isnull(a0308,0)+isnull(a0310,0)+isnull(a0311,0)+isnull(a0312,0))
from A11
