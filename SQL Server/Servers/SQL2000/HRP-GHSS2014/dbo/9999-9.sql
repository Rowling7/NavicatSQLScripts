...
(
SELECT A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q,R
from OPENROWSET('Microsoft.ACE.OLEDB.12.0','Excel 8.0;HDR=YES;DATABASE=D:\Desktop\汇总\K03\34-报公路局-L11-2-202403011500-1.xlsx',sheet1$)

UNION
SELECT A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q,R
from OPENROWSET('Microsoft.ACE.OLEDB.12.0','Excel 8.0;HDR=YES;DATABASE=D:\Desktop\汇总\K03\34-报公路局-L11-2-202403011500-2.xlsx',sheet1$)

UNION
SELECT A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q,R
from OPENROWSET('Microsoft.ACE.OLEDB.12.0','Excel 8.0;HDR=YES;DATABASE=D:\Desktop\汇总\K03\34-报公路局-L11-2-202403011500-3.xlsx',sheet1$)

UNION
SELECT A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q,R
from OPENROWSET('Microsoft.ACE.OLEDB.12.0','Excel 8.0;HDR=YES;DATABASE=D:\Desktop\汇总\K03\34-报公路局-L11-2-202403011500-4.xlsx',sheet1$)
) XLS
SELECT * FROM #TK03
/*
--132764
...
SELECT A0102,A,K0101,F,HA5009,D,E,K0108,K0109,K,A5010,M,N,A5011A,A5011B
--UPDATE [HRP-GHSS2014]..K03 SET A5011A=M,A5011B=N
FROM #TK03 T
INNER JOIN [HRP-GHSS2014]..K03 K ON T.A=K.K0101 AND T.D=K.K0108 AND T.E=K.K0109 AND F=HA5009
WHERE K<>A5010
...
SELECT DISTINCT LEFT(RIGHT(a,6),4)
--UPDATE [HRP-GHSS2014]..K03 SET A5010=K
FROM #TK03 T
INNER JOIN [HRP-GHSS2014]..K03 K ON T.A=K.K0101 AND T.D=K.K0108 AND T.E=K.K0109 AND F=HA5009
WHERE K<>A5010
ORDER BY LEFT(RIGHT(a,6),4)