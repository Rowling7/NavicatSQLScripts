...
INSERT #TimeTable SELECT '请输入汇总年份:',CONVERT(CHAR(4),GETDATE(),112)

		declare @CurYear char(4)
		declare @LastYear char(4)
		set @CurYear =(select ParamValue from #TimeTable)
		set @LastYear=(SELECT CONVERT(CHAR(4),DATEADD(year,-1,CAST(@CurYear AS DATETIME)),112 ))
		--------------------------
		if object_id('tempdb..#备份A52') is not null 	drop table #备份A52
		select a0102,k0101,a0101,k0105,a3219,K0116,A0410 into #备份A52 from A52 where left(A0101,4)=@CurYear

		if object_id('tempdb..#备份K01') is not null 	drop table #备份K01
		...
		into #备份K01 from K01 where left(A0101,4)=@CurYear and BG0102 is not null

		if object_id('tempdb..#备份K60') is not null 	drop table #备份K60
		...
		into #备份K60 from K60 where left(A0101,4)=@CurYear and BG0202 is not null

		if object_id('tempdb..#备份K63') is not null 	drop table #备份K63
		...
		into #备份K63 from K63 where left(A0101,4)=@CurYear and BG0302 is not null
		...
		set K0105=0,--路线起点桩号
		K0106=0 --路线终点桩号
		from A50 a left join [HRP-DBMS2015]..A50 b on a.A0102=b.A0102 and a.K0101=b.K0101
		where b.A0102 is null
		*/
		...
		--rtrim(K0191),--改建变更日期
		(case when left(rtrim(K6101),4)=@CurYear and rtrim(K0191) is null then rtrim(K6101) else rtrim(K0191) end) K0117,--改建变更日期
		(case when left(rtrim(k6100),4)=@CurYear then '1' 
			 when left(rtrim(K6101),4)=@CurYear then '2' else '9' end),--建设性质
		(case when left(rtrim(k6100),4)=@CurYear then '新建' 
			 when left(rtrim(K6101),4)=@CurYear then '改建' else '其他' end), --建设性质
		...
		rtrim(K6122),rtrim(HK6122) --评定为四五类桥梁的原因
		...
		--rtrim(K0191),--改建变更日期
		(case when left(rtrim(K6101),4)=@CurYear and rtrim(K0191) is null then rtrim(K6101) else rtrim(K0191) end) K0117,--改建变更日期
		(case when left(rtrim(K6340),4)=@CurYear then '1' 
			 when left(rtrim(K6101),4)=@CurYear then '2' else '9' end),--建设性质
		(case when left(rtrim(K6340),4)=@CurYear then '新建' 
			 when left(rtrim(K6101),4)=@CurYear then '改建' else '其他' end), --建设性质
		...
		rtrim(K3909),rtrim(HK3909),--变更原因
		(case when left(rtrim(K0190),4)=@CurYear then '1' 
			 when left(rtrim(K0191),4)=@CurYear then '2' else '9' end),--建设性质
		(case when left(rtrim(K0190),4)=@CurYear then '新建'
			 when left(rtrim(K0191),4)=@CurYear then '改建' else '其他' end) --建设性质
...
*/
		...
		(case when K0193=@CurYear and rtrim(K0191) is null then rtrim(K0193) else rtrim(K0191) end) K0117, --变更日期
		K3102,hK3102,--GBM建设性质
		K3108,--已实施GBM起点桩号
		K3109,--已实施GBM止点桩号
		K3208,--文明样板路起点桩号
		...
		rtrim(K3909),rtrim(HK3909),--变更原因
		(case when K0190=@CurYear then '1' when K0193=@CurYear then '2' else '9' end),--建设性质
		(case when K0190=@CurYear then '新建' when K0193=@CurYear then '改建' else '其他' end), --建设性质
		rtrim(K6023),rtrim(HK6023),--抗震等级
		rtrim(K0149),rtrim(HK0149) --防洪标准(年)
		...
		------------------------------------------A51表
		if not exists(select top 1 * from A51 where left(A0101,4)<@CurYear)
		begin
		delete a51 where left(A0101,4)=@CurYear
		...
		into #本年到达里程
		from K01 
		where left(k0101,1) in ('G','S','X','Y','Z','C') and left(A0101,4)=@CurYear 
		...
		into #本年到达桥梁
		from k60 
		where left(A0101,4)=@CurYear and isnull(K6008,0)<>0 --桥梁全长为0,则不计数
		group by a0102,k0101
		------------------------------------------
		--以下计算隧道
		...
		into #本年到达隧道
		from k63
		where left(A0101,4)=@CurYear and isnull(K6305,0)<>0 --20011217修改 隧道长度为0,则不计数
		group by a0102,k0101
		------------------------------------------
		--以下计算渡口
		...
		into #本年到达渡口
		from k65
		where left(A0101,4)=@CurYear and isnull(K6523,0)<>0 --20011217修改 渡口宽度为0,则不计数
		group by a0102,k0101
		------------------------------------------
		...
		select a0102,ha0102,k0101,'9','其他',@CurYear,@CurYear+'年',11111,22222,'aa','2005','请输入','请输入' from A50
		------------------------------------------
		-----------到达数直接填写到A51表中.
		update a51 set
		A0304=[高速四车道里程],
		...
		from #本年到达里程 
		where 
		a51.a0101=@CurYear and a51.a3219='9' and
		...
		into #本年新建里程
		from K01 
		where left(k0101,1) in ('G','S','X','Y','Z','C') and a0101=@CurYear and a3219='1' --and isnull(v0301,'2')='2'
		group by A0102,K0101
		--------------------------------------
		...
		where left(k01.k0101,1) in ('G','S','X','Y','Z','C') and a0101=@CurYear and a3219<>'1'
		...
		into #本年新建桥梁
		from k60 
		where a0101=@CurYear and a3219='1' and isnull(K6008,0)<>0 --20011217修改 桥梁全长为0,则不计数
		group by a0102,k0101
		----------------------------------------
		...
		where a0101=@CurYear and a3219<>'1' and isnull(K6008,0)<>0
		group by A50.A0102,A50.K0101
		order by A50.A0102,A50.K0101
		------------------------------------------
		--以下计算隧道
		...
		into #本年新建隧道
		from k63
		where a0101=@CurYear and a3219='1' and isnull(K6305,0)<>0 --20011217修改 隧道长度为0,则不计数
		group by a0102,k0101
		----------------------------------------
		...
		where a0101=@CurYear and a3219<>'1' and isnull(K6305,0)<>0
		group by A50.A0102,A50.K0101
		order by A50.A0102,A50.K0101
		-------------------------------------------
		--以下计算渡口
		...
		where left(A0101,4)=@CurYear and a3219<>'1' and isnull(K6523,0)<>0
		group by A50.A0102,A50.K0101
		order by A50.A0102,A50.K0101
		-------------------------------------------
		--下面计算上年底到达,#上年底到达
		...
		--下面(^@^):由于所有里程为0的不计算，所以路线名称、通车日期等字段不能填写到A51表中.
		insert a51 (a0102,ha0102,k0101,a3219,ha3219,a0101,ha0101,K0105,K0106,A0203,k0116,k0103,k0104)
		select a0102,ha0102,k0101,'1','新建',@CurYear,@CurYear+'年',11111,22222,'aa','2005','请输入','请输入' from A50

		insert a51 (a0102,ha0102,k0101,a3219,ha3219,a0101,ha0101,K0105,K0106,A0203,k0116,k0103,k0104)
		select a0102,ha0102,k0101,'2','改建',@CurYear,@CurYear+'年',11111,22222,'aa','2005','请输入','请输入' from A50
		------------------------------------------
		--新建数直接填写到A51表中.
		update a51 set
		A0304=[高速四车道里程],
		...
		A0534=a.A0534
		from #本年改建里程 a 
		where a51.a3219='2' and a51.a0101=@CurYear and a51.a0102=a.a0102 and a51.k0101=a.k0101
		---------------------
		update a51
		set 
		A0503=a.A0503,
		...
		if not exists(select top 1 * from A52 where left(A0101,4)<@CurYear)
		begin
		delete a52 where left(A0101,4)=@CurYear
		...
		where 
			...
			left(A0101,4)=@CurYear and (K0304='10' or K0304='11') 
		...
		select a0102,ha0102,k0101,'9','其他',@CurYear,@CurYear+'年',0,1,'a','b','2008','2008','9','请输入' from A50
		------------------------------------------
		-----------新建数直接填写到A52表中.
		update a52 set
		A0304=[高速四车道里程],
		...
		from #本年到达里程A52 
		where 
		a52.a0101=@CurYear and a52.a3219='9' and
		...
		where 
			(K0124 is null OR K0124='') AND ISNULL(K0123,'2')='2' and 
			left(A0101,4)=@CurYear and a3219='1' and (K0304='10' or K0304 = '11')
			and left(k0101,1) in ('G','S','X','Y','Z','C')	
		group by A0102,K0101
		---------------------------------
		--本年非新建里程数据
		...
		where 	(K0124 is null OR K0124='') AND ISNULL(K0123,'2')='2' 
			and left(A0101,4)=@CurYear and a3219<>'1' and (K0304='10' or K0304='11')
			and left(k0101,1) in ('G','S','X','Y','Z','C')					 
		group by A0102,K0101
		---------------------------------
		--上年底到达里程数据
		...
		from L01
		where 	(K0124 is null OR K0124='') AND ISNULL(K0123,'2')='2' 
			and left(A0101,4)=@LastYear and (K0304='10' or K0304='11')
			and left(k0101,1) in ('G','S','X','Y','Z','C')		 			 
		group by A0102,K0101
		*/
		...
		insert a52 (a0102,ha0102,k0101,a3219,ha3219,a0101,ha0101,K0105,K0106,K0103,K0104,a0410,k0116,a0131,a0130)
		select a0102,ha0102,k0101,'1','新建',@CurYear,@CurYear+'年',0,1,'a','a','2003','2003','9','请输入' from A50

		insert a52 (a0102,ha0102,k0101,a3219,ha3219,a0101,ha0101,K0105,K0106,K0103,K0104,a0410,k0116,a0131,a0130)
		select a0102,ha0102,k0101,'2','改建',@CurYear,@CurYear+'年',0,1,'a','a','2003','2003','9','请输入' from A50
		------------------------------------------
		-----------新建数直接填写到A52表中.
		update a52 set
		A0304=[高速四车道里程],
		...
		from #本年改建里程A52 
		where 
		a52.a0101=@CurYear and a52.a3219='2' and
		...
		where a51.a0101=@CurYear
		
		update A51 set HA0203=objjc from D001 where A0203=objname and left(A0101,4)=@CurYear
		update a set a.K0112=b.K0112 from A51 a,A50 b where a.K0101=b.K0101 and a.a0102=b.A0102 and a.a0101=@CurYear
		update a set a.K0106=b.K0106 from A51 a,A50 b where a.K0101=b.K0101 and a.a0102=b.A0102 and a.a0101=@CurYear
		update a set a.K0105=b.K0105 from A51 a,A50 b where a.K0101=b.K0101 and a.a0102=b.A0102 and a.a0101=@CurYear
		update a set a.k0103=b.k0103 from A51 a,A50 b where a.K0101=b.K0101 and a.a0102=b.A0102 and a.a0101=@CurYear
		update a set a.k0104=b.k0104 from A51 a,A50 b where a.K0101=b.K0101 and a.a0102=b.A0102 and a.a0101=@CurYear
		update a set a.K0116=b.K0116 from A51 a,A50 b where a.K0101=b.K0101 and a.a0102=b.A0102 and a.a0101=@CurYear
        	update a set a.A0130=b.A0130 from A51 a,A50 b where a.A0130 is null and a.K0101=b.K0101 and a.a0102=b.A0102 and a.a0101=@CurYear
        	update a set a.A0131=b.A0131 from A51 a,A50 b where a.A0131 is null and a.K0101=b.K0101 and a.a0102=b.A0102 and a.a0101=@CurYear
                update a set a.HA0131=b.HA0131 from A51 a,A50 b where a.HA0131 is null and a.K0101=b.K0101 and a.a0102=b.A0102 and a.a0101=@CurYear   
	        update a set a.K0116=b.K0116 from A51 a,A50 b where a.K0116 is null and a.K0101=b.K0101 and a.a0102=b.A0102 and a.a0101=@CurYear --and a.a3219=b.a3219 and a.K0105=b.K0105 and a.a0101=b.a0101                
		...
		into #改建路段起止点信息
		from k01
		where left(a0101,4) = @CurYear and a3219 = '2' and left(k0101,1) in ('G','S','X','Y','Z','C')
		group by a0102,k0101
		...
		update a set a.K0112=b.K0112 from A52 a,A50 b where a.K0101=b.K0101 and a.a0102=b.A0102 and a.a0101=@CurYear
		update a set a.K0106=b.K0106 from A52 a,A50 b where a.K0101=b.K0101 and a.a0102=b.A0102 and a.a0101=@CurYear
		update a set a.K0105=b.K0105 from A52 a,A50 b where a.K0101=b.K0101 and a.a0102=b.A0102 and a.a0101=@CurYear
		update a set a.k0103=b.k0103 from A52 a,A50 b where a.K0101=b.K0101 and a.a0102=b.A0102 and a.a0101=@CurYear
		update a set a.k0104=b.k0104 from A52 a,A50 b where a.K0101=b.K0101 and a.a0102=b.A0102 and a.a0101=@CurYear
		update a set a.K0116=b.K0116 from A52 a,A50 b where a.K0101=b.K0101 and a.a0102=b.A0102 and a.a0101=@CurYear
        	update a set a.A0130=b.A0130 from A52 a,A50 b where a.K0101=b.K0101 and a.a0102=b.A0102 and a.a0101=@CurYear
        	update a set a.A0131=b.A0131 from A52 a,A50 b where a.K0101=b.K0101 and a.a0102=b.A0102 and a.a0101=@CurYear
        	update a set a.HA0131=b.HA0131 from A52 a,A50 b where a.K0101=b.K0101 and a.a0102=b.A0102 and a.a0101=@CurYear
        	update a set a.K0116=rtrim(b.K0116) from A52 a,#备份A52 b where a.K0116 is null and a.K0101=b.K0101 and a.a0102=b.A0102 and a.a0101=@CurYear and a.a3219=b.a3219 and a.K0105=b.K0105 and a.a0101=b.a0101                
        	update a set a.A0410=rtrim(b.A0410) from A52 a,#备份A52 b where a.A0410 is null and a.K0101=b.K0101 and a.a0102=b.A0102 and a.a0101=@CurYear and a.a3219=b.a3219 and a.K0105=b.K0105 and a.a0101=b.a0101                
		...
		into #改建路段起止点信息A52
		from k01
		where left(a0101,4) = @CurYear and a3219 = '2' and left(k0101,1) in ('G','S','X','Y','Z','C') and k0304 in ('10','11')
		group by a0102,k0101
		...
		update a52 set k0106 = gj.k0106 from #改建路段起止点信息A52 gj where a52.a0102 = gj.a0102 and a52.k0101 = gj.k0101 and left(a52.a0101,4) = @CurYear and a52.a3219 = '2'
		update a52 set k0105 = gj.k0105 from #改建路段起止点信息A52 gj where a52.a0102 = gj.a0102 and a52.k0101 = gj.k0101 and left(a52.a0101,4) = @CurYear and a52.a3219 = '2'
		update a52 set k0103 = gj.k0103 from #改建路段起止点信息A52 gj where a52.a0102 = gj.a0102 and a52.k0101 = gj.k0101 and left(a52.a0101,4) = @CurYear and a52.a3219 = '2'
		update a52 set k0104 = gj.k0104 from #改建路段起止点信息A52 gj where a52.a0102 = gj.a0102 and a52.k0101 = gj.k0101 and left(a52.a0101,4) = @CurYear and a52.a3219 = '2'
		...
		from k01
		where left(a0101,4) = @CurYear and a3219 = '9' and left(k0101,1) in ('G','S','X','Y','Z','C') and k0304 in ('10','11')
		group by a0102,k0101
		...
		----------------------------------------------------------------------------------
		--导数据到A11
		delete a11 where a0101=@CurYear
		...
		select A0102,max(HA0102),@CurYear,@CurYear+'年',A0203,max(HA0203),A3219,max(HA3219),sum(A0304),sum(A0305),sum(A0306),sum(A0307),sum(A0308),sum(A0309),sum(A0310),sum(A0311),sum(A0312),sum(A0320),
		...
		from k01 left join #备份K01 a on k01.a0102=a.a0102 and k01.k0101=a.k0101 and k01.a0101=a.a0101 and k01.k0108=a.k0108
		where left(k01.A0101,4)=@CurYear and a.a0102 is not null
		...
		from k60 left join #备份K60 a on k60.a0102=a.a0102 and k60.k0101=a.k0101 and k60.a0101=a.a0101 and k60.k6001=a.k6001
		where left(k60.A0101,4)=@CurYear and a.a0102 is not null
		...
		from k63 left join #备份K63 a on k63.a0102=a.a0102 and k63.k0101=a.k0101 and k63.a0101=a.a0101 and k63.k6301=a.k6301
		where left(k63.A0101,4)=@CurYear and a.a0102 is not null

		----------------------------------------------------------------------------------
		------------汇总A12养护里程------------------------------------
		delete A12 where a0101=@CurYear
		...
		update a12 set ha0203=objjc from a12 join d001 on(objname=a0203) where left(a0101,4) = @CurYear
		...
		--汇总绿化表
		if NOT EXISTS(select top 1 a0101 from a13 where a0101=(select objname from d031 where objexplain = (select paramvalue from #TimeTable)))
		begin
			insert a13 (
				HA0102,--管理单位代码
				A0102,--管理单位名称
			...
			and a0101 = @CurYear and left(k0101,1) in ('G','S','X','Y','Z','C')
			group by a0102,case when left(replace(replace(replace(replace(K0101,'H','G'),'T','S'),'J','X'),'N','Y'),1)='G' then
					       (case when left(replace(replace(replace(replace(K0101,'H','G'),'T','S'),'J','X'),'N','Y'),1)='G' and len(ltrim(rtrim(k0101)))<=9  then 'GA' else 'G9' end)
					       else upper(left(replace(replace(replace(replace(K0101,'H','G'),'T','S'),'J','X'),'N','Y'),1))
					      end  
		...
		----------------------------------------------------------------------------------
		update K01 set HA0102=objjc from D028 where A0102=objname and left(A0101,4)=@CurYear
		update A12 set HA0102=objjc from D028 where A0102=objname and left(A0101,4)=@CurYear
		update A13 set HA0102=objjc from D028 where A0102=objname and left(A0101,4)=@CurYear
		----------------------------------------------------------------------------------
		----更新路线简称
		EXEC PR_EXECSQL2
