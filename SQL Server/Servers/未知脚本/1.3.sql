...
SELECT RTRIM(K.A0102) A0102,RTRIM(K.K0101) K0101,RTRIM(L.A0102) LA0102,RTRIM(L.K0101) LK0101, K.K0108,K.K0109 , L.K0108 LK0108,L.K0109 LK0109,K.K0180,K.HA3219,K.hk3912,k.k1302 ,k.k1303 ,k.k1304 --,RTRIM(K.KWYID) KWYID,RTRIM(L.KWYID) LKWYID
FROM K001  K
LEFT JOIN #TK001 L ON K.A0102=L.A0102 AND K.K0101=L.K0101 
where  k.a3219<>'1'  and RTRIM(L.A0102)is not null 
and k.k1302 is null
...
SELECT RTRIM(K.A0102) A0102,RTRIM(K.K0101) K0101, K.K0108,K.K0109 ,K.K0180,K.HA3219,K.hk3912,k.k1302 ,k.k1303 ,k.k1304 
--UPDATE K SET K.k1302=K.K0101 ,k1303 =k.K0108,k1304=k.K0109
FROM K001  K 
where  k.a3219<>'1'  and k.k1302 is null

SELECT k1302
--update k001 set k1302=rtrim(k0101),k1303 =K0108,k1304=K0109
FROM K001
where   a3219<>'1'
AND  k1302 is null
