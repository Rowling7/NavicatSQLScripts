...
CREATE TABLE [dbo].[SXZB] (
  [NUM] varchar(255) COLLATE Chinese_PRC_CI_AS not NULL,
...
SELECT 
NUM,
convert(varchar(255),cast(convert(float,XZDM) as decimal)) XZDM,XZMC,TDQK,HTDQK,NBTABLE,nbnf
from OPENROWSET('Microsoft.jet.OLEDB.4.0','Excel 5.0;HDR=YES;DATABASE=D:\东方永德软件OYDSOFT 安徽\SXZB20231217.xls',sheet3$)
...
from zrc 
left join sxzb on V5701=xzdm
where tdqk is not null and V5708<>tdqk AND NBTABLE='V532' --and nbnf='2023'
*/
...
from v52 
left join sxzb on V0514=xzdm
where tdqk is not null and v0513<>tdqk and nbtable='v52' and left(V0514,4)='3407' and nbnf='2023'
...
from v53 
left join sxzb on V5701=xzdm
where tdqk is not null and V5708<>tdqk and nbtable='v53' and left(V0514,4)='3410' and tdqk='1' and nbnf='2023'
