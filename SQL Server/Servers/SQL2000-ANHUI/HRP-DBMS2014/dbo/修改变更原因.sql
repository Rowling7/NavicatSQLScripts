...
--“原路线代码”不在上年路段表内
SELECT RTRIM(K001.K0101)+RTRIM(K0115),HK5104,HK0304,KWYID,k3912,hk3912,K0101,k1302,K0108,k1303,K0109,k1304,XLS.Z
...
from OPENROWSET('Microsoft.JET.OLEDB.4.0','Excel 5.0;HDR=YES;DATABASE=D:\Desktop\表.xls',sheet10$)
)XLS ON RTRIM(K001.K0101)+RTRIM(K0115)=XLS.Z
WHERE XLS.Z IS NOT NULL
ORDER BY KWYID


SELECT RTRIM(K001.K0101)+RTRIM(K0115),HK5104,HK0304,KWYID,k3912,hk3912,RTRIM(K0101) K0101,k1302,K0108,k1303,K0109,k1304,XLS.Z
--UPDATE K001 SET K3912='21',HK3912='指标变更或地理位置变更',k1302=NULL,k1303=NULL,k1304=NULL
from K001 
LEFT JOIN (
SELECT DISTINCT SUBSTRING(a,charindex(',路段代码=',a)+7,13) Z
from OPENROWSET('Microsoft.JET.OLEDB.4.0','Excel 5.0;HDR=YES;DATABASE=D:\Desktop\表.xls',sheet10$)
WHERE  SUBSTRING(a,charindex(',路段代码=',a)+7,13) NOT LIKE 'CZO6340828009%'
)XLS ON RTRIM(K001.K0101)+RTRIM(K0115)=XLS.Z
WHERE XLS.Z IS NOT NULL
ORDER BY KWYID
*/
...
------------------------------------------------0118
---“技术状况评定等级”为“1/2/3/9”时，无需填写“评定为四五类桥梁的原因”
SELECT k6028,k6122
--update k060 set k6122 = null,hk6122 = null
from K060
where k6028 in ('1','3') and k6122 is not null
