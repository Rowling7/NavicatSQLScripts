...
from OPENROWSET('Microsoft.jet.OLEDB.4.0','Excel 5.0;HDR=YES;DATABASE=D:\东方永德软件OYDSOFT 安徽\SXZB20231217.xls',sheet1$)
...
from jzc 
left join sxzb on V0514=xzdm
where tdqk is not null and v0513<>tdqk  and nbnf='2023'

update zrc set V5708=TDQK,hV5708=HTDQK
--SELECT V5708,TDQK,hV5708,HTDQK
from zrc 
left join sxzb on V5701=xzdm
where tdqk is not null and V5708<>tdqk  and nbnf='2023'
*/