...
SELECT  a0102,k0101,k3912,Hk3912,k0180,A9903,k1302
--update k001 set A9903 =NULL
from k001 
where k3912 IN('11','14') and k1302 is not null
ORDER  BY k3912,A9903 DESC

SELECT A0102,K0101,RTRIM(K0112) K0112, K3912,Hk3912,k1302
FROM K001 
--WHERE K3912='11'
--WHERE K3912='14'
--WHERE K3912='21'
WHERE K3912 IN ('11','14')
ORDER BY k3912,k1302 desc
