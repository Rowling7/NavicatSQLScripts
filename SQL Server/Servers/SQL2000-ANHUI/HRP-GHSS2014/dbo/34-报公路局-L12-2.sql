...
WHERE B17.A0102 LIKE '34%' AND LEN(B17.K0101)>=10
	AND B17.A0101 = '2023'
GROUP BY RTRIM(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(B17.K0101,'340000',''),'000000',''),'D001',''),'D002',''),'D003','')),a3094,rtrim(ha3094) WITH ROLLUP
having grouping(a3094)=grouping(rtrim(ha3094))  and (grouping(a3094)=0 or (grouping(a3094)=1 and grouping(RTRIM(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(B17.K0101,'340000',''),'000000',''),'D001',''),'D002',''),'D003','')))=1))
