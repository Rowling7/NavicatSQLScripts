...
select * 
from k03 
where left(rtrim(a0101a),4)='2023' and a5011a is null and a5011b is null


--260861
update k03 set a5011a=a5011,a5011b=a5010
from k03 
where left(rtrim(a0101a),4)='2023' and a5011a is null and a5011b is null


select distinct rtrim(a0101a) from k03
--202343

select distinct rtrim(a5082),rtrim(ha5082) from k03
...
--12386
update k03 set a5082='2',ha5082='指南'
from k03 
where rtrim(a5082)='1' and rtrim(ha5082)='指南'

-----------------------------------------------------------------

select k5104 from K03 where  k0304 in ('11','22') group by k5104

select * from K03 where k0304 in ('11','22') and a5082 in ('2');
select * from K03 where k0304 in ('11','22') and a5082 in ('3');

--1、一二级路填指南的批成5210
--752
update K03 set a5082='1',ha5082='5210' where k0304 in ('11','22') and a5082 in ('2');
...
------------------------------------------------------------------------------------下面不用，检测标准代码与汉字不符，已调整。
--8、四级路，等外路且沥青或水泥，三级及以下并且砂石，指南，PCI=PQI，
--7169
select k0101,k0108,ha5009,k0304,hk0304,left(hk5104,2) hk5104,a5010,a5011,a5011a,a5011b,a5082,abs(a5011a-a5011) 差值
from K03 
where ((k0304 in('24','30') and k5104 in ('11','12','21','22','23')) or (k0304 in('23','24','30') and k5104 in ('31')))
...
--0
select * from k03 where a5010>100 or a5010<0

--0
select * from k03 where a5011>100 or a5011<0

--1
select * from k03 where a5011a>100 or a5011a<0

--Y023341302     202343  	2023年12月          	1.000	1.387	2	上行  	

--0
select * from k03 where a5011b>100 or a5011b<0
